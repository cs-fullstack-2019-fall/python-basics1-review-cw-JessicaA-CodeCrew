...
while askUser != 'Q': # this should be a lower case q
    askUser = input("More Info: ")
print(askUser)
...
#
askUser = input('Enter 1 or 2: ')
while askUser == 1: # your loop should stop when the user enters q or 0
    print("1")
    if askUser == 2:
        print("2")
...
ask1 = input("Enter Input: ")
while ask1 == input(): # your loop should stop when the user enters q
    print( ask1, ",",ask1, ",", ask1)